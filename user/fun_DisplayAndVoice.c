 ...
 * @LastEditTime: 2020-08-22 10:53:30
...
void DisplayException(void) //错误显示
{
	...
	{
		chErrorCodeSer = 16;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 16, 0);
		if (chLanguage == 1)
		{
			LCD_Display(8, 32, 14, LEFT, CHS15x16, "压脚位置不正确");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(4, 32, 17, LEFT, EN5x7, "Lift switch error");
		}
		else
		{
			LCD_Display(0, 16, 62, LEFT, TR5x7, "Bask\x0fd aya\x0f0\x0fd koruyucu a\x0e7ma kapama do\x0f0ru    ayar konumunda de\x0f0il");
		}
	}
	else if ((wException & E_HEADSWITCH) > 0)
	{
		chErrorCodeSer = 17;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 17, 0);
		if (chLanguage == 1)
		{
			LCD_Display(8, 32, 14, LEFT, CHS15x16, "缝台位置不正确");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(0, 32, 34, LEFT, EN5x7, " Sewing table switch         error");
		}
		else
		{
			LCD_Display(0, 16, 68, LEFT, TR5x7, "Diki\x0fd platformu      koruyucu a\x0e7ma kapama do\x0f0ru ayar konumunda de\x0f0il");
		}
	}
	else if ((wException & E_V) > 0)
	{
		chErrorCodeSer = 1;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 1, 0);
		if (chLanguage == 1)
		{
			LCD_Display(32, 32, 8, LEFT, CHS15x16, "系统过压");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(0, 32, 35, LEFT, EN5x7, "   Power Module is           faulty");
		}
		else
		{
			LCD_Display(0, 16, 67, LEFT, TR5x7, "Elektrik kayna\x0f0\x0fd a\x0e7\x0fdk oldu\x0f0unda,ana voltaj tespiti \x0e7ok y\x0fcksek  olur");
		}
	}
	else if ((wException & E_LV) > 0)
	{
		chErrorCodeSer = 2;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 2, 0);
		if (chLanguage == 1)
		{
			LCD_Display(32, 32, 8, LEFT, CHS15x16, "系统欠压");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(10, 32, 18, LEFT, EN5x7, "Voltage is too low");
		}
		else
		{
			LCD_Display(0, 16, 67, LEFT, TR5x7, "Elektrik kayna\x0f0\x0fd a\x0e7\x0fdk oldu\x0f0unda,ana voltaj tespiti \x0e7ok d\x0fc\x0fe\x0fck   olur");
		}
	}
	else if ((wException & E_STEM) > 0)
	{
		chErrorCodeSer = 7;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 7, 0);
		if (chLanguage == 1)
		{
			LCD_Display(32, 32, 8, LEFT, CHS15x16, "电机堵转");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(22, 32, 14, LEFT, EN5x7, "Machine locked");
		}
		else
		{
			LCD_Display(0, 16, 111, LEFT, TR5x7, "Motor kablosunun     gev\x0feek ve hasarl\x0fd    olmas\x0fd elektrik      iletiminin do\x0f0ru     yap\x0fdlamamas\x0fdna neden oluyor");
		}
	}
	else if ((wException & E_BACKTIMEOUT) > 0)
	{
		chErrorCodeSer = 18;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 18, 0);
		if (chLanguage == 1)
		{
			LCD_Display(16, 32, 12, LEFT, CHS15x16, "针杆护罩保护");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(0, 32, 36, LEFT, EN5x7, "   Needle bar cover       protection");
		}
		else
		{
			LCD_Display(0, 16, 36, LEFT, TR5x7, "   Needle bar cover       protection");
		}
	}
	else if ((wException & E_LOCATIONB) > 0)
	{
		chErrorCodeSer = 9;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 9, 0);
		if (chLanguage == 1)
		{
			LCD_Display(8, 32, 14, LEFT, CHS15x16, "定位器信号异常");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(0, 33, 26, LEFT, EN5x7, " Synchronizer signal        error");
		}
		else
		{
			LCD_Display(0, 16, 28, LEFT, TR5x7, "Pozisyon sinyali     anormal");
		}
	}
	else if ((wException & E_FINDUP) > 0)
	{
		chErrorCodeSer = 11;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 11, 0);
		if (chLanguage == 1)
		{
			LCD_Display(8, 32, 14, LEFT, CHS15x16, "无法找到上定位");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(0, 32, 35, LEFT, EN5x7, "  Auto needle up is          faulty");
		}
		else
		{
			LCD_Display(0, 16, 28, LEFT, TR5x7, "Pozisyon sinyali     anormal");
	...
	else if ((wException & E_ENCODER) > 0)
	{
		chErrorCodeSer = 14;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 14, 0);
		if (chLanguage == 1)
		{
			LCD_Display(8, 32, 14, LEFT, CHS15x16, "编码器信号异常");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(4, 32, 20, LEFT, EN5x7, "Encoder signal error");
		}
		else
		{
			LCD_Display(0, 16, 28, LEFT, TR5x7, "Kodlay\x0fdc\x0fd sinyali    anormal");
		}
	}
	else if ((wException & E_OVERCUR) > 0)
	{
		chErrorCodeSer = 15;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 15, 0);
		if (chLanguage)
		{
			LCD_Display(16, 32, 8, LEFT, CHS15x16, "系统过流保护");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(0, 32, 35, LEFT, EN5x7, "  Power Module over         current");
		}
		else
		{
			LCD_Display(0, 16, 51, LEFT, TR5x7, "G\x0fc\x0e7 mod\x0fcl\x0fc a\x0fe\x0fdr\x0fd ak\x0fdm koruyucu normal     i\x0felemiyor");
		}
	}
	else if ((wException & E_LOCATION) > 0)
	{
		chErrorCodeSer = 12;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 12, 0);
		if (chLanguage == 1)
		{
			LCD_Display(16, 32, 12, LEFT, CHS15x16, "未插入定位器");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(19, 32, 15, LEFT, EN5x7, "No synchronizer");
		}
		else
		{
			LCD_Display(0, 16, 16, LEFT, TR5x7, "Hay\x0fdr E\x0feitleyici");
		}
	}
	else if ((wException & E_PEDAL) > 0)
	{
		chErrorCodeSer = 5;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 5, 0);
		if (chLanguage)
		{
			LCD_Display(24, 32, 10, LEFT, CHS15x16, "控速器故障");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(40, 32, 8, LEFT, EN5x7, "No pedal");
		}
		else
		{
			LCD_Display(0, 16, 27, LEFT, TR5x7, "Kontrol\x0f6r ba\x0f0lant\x0fds\x0fd hatal\x0fd");
		}
	}
	else if ((wException & E_OVERCURB) > 0)
	{
		chErrorCodeSer = 10;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 10, 0);
		if (chLanguage == 1)
		{
			LCD_Display(8, 32, 14, LEFT, CHS15x16, "电磁铁过流保护");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(0, 32, 35, LEFT, EN5x7, "  Electromagnet over        current");
		}
		else
		{
			LCD_Display(0, 16, 35, LEFT, TR5x7, "Elektromanyetik a\x0fe\x0fdr\x0fd ak\x0fdm koruyucu");
		}
	}
	else if ((wException & E_START) > 0)
	{
		chErrorCodeSer = 20;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 20, 0);
		if (chLanguage == 1)
		{
			LCD_Display(8, 32, 12, LEFT, CHS15x16, "电机启动失败");
		}
		else if (chLanguage == 0)
		{
			LCD_Display(7, 32, 19, LEFT, EN5x7, "Motor start failure");
		}
		else
		{
			LCD_Display(7, 16, 19, LEFT, TR5x7, "Motor start failure");
		}
	}
	else if ((wException & E_COM) > 0)
	{
		chErrorCodeSer = 3;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 3, 0);
		if (chLanguage == 1)
		{
			LCD_Display(32, 32, 8, LEFT, CHS15x16, "通讯异常");
		}
	...
	else if ((wException & E_HANDCUT) > 0)
	{
		chErrorCodeSer = 3;
		//LCD_DisNumberB(chStartx, 8, 2, LEFT, EN8x16, 23, 0);
		if (chLanguage)
		{
			LCD_Display(64 - 48, 32, 12, LEFT, CHS15x16, "手动剪线锁定");
			LCD_Display(64 - 36, 48, 9, LEFT, CHS15x16, "按P键解除");
